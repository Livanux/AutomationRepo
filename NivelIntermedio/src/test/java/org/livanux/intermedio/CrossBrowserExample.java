...
public class CrossBrowserExample {
    ...
    private void setDriverProperties(String prop, String driver){
        System.setProperty("webdriver."+prop+".driver",
                System.getProperty("user.dir")+"\\drivers\\"+driver+".exe");
    }
    ...
    public void launchBrowser(String browser) throws Exception{
        switch (browser.toLowerCase()){
            case "chrome":
                setDriverProperties("chrome", "chromedriver");
                driver = new ChromeDriver();
                break;
            case "firefox":
                setDriverProperties("gecko", "geckodriver");
                driver = new FirefoxDriver();
                break;
            case "ie":
                setDriverProperties("ie", "IEDriverServer");
                driver = new InternetExplorerDriver();
            case "edge":
                setDriverProperties("edge", "MicrosoftWebDriver");
