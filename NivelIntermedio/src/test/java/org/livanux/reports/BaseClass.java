...
public class BaseClass {
    ...
    //Setter (Mutators) y Getters (Accessors)
    ...
    public static void sendPdfByEmail(String from, String pass, String to, String subject, String body) {
        ...
        try {
            ...
            String fileName = System.getProperty("user.dir") + "\\NivelIntermedio.pdf";
